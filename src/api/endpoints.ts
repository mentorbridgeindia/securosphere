...
export const THIRD_PARTY_RESET_PASSWORD_ENDPOINT = `account/tp-client/reset-password`;
export const THIRD_PARTY_CHANGE_PASSWORD_ENDPOINT = `account/tp-client/change-password`;
